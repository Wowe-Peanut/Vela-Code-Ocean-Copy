...
results = pd.DataFrame({
    'Brier Loss Mean (Prior)': metrics['Brier Loss']['mean'],
    'Brier Loss Std (Prior)': metrics['Brier Loss']['std'],
    'Accuracy Mean (Prior)': metrics['Accuracy']['mean'],
    'Accuracy Std (Prior)': metrics['Accuracy']['std'],
    'Recall Mean (Prior)': metrics['Recall']['mean'],
    'Recall Std (Prior)': metrics['Recall']['std'],
    'F1 Score Mean (Prior)': metrics['F1 Score']['mean'],
    'F1 Score Std (Prior)': metrics['F1 Score']['std'],
    'Precision Mean (Prior)': metrics['Precision']['mean'],
    'Precision Std (Prior)': metrics['Precision']['std'],
    'Log Loss Mean (Prior)': metrics['Log Loss']['mean'],
    'Log Loss Std (Prior)': metrics['Log Loss']['std'],
})

results.to_excel('/data/ys_avg_metrics_prior.xlsx', index=False)