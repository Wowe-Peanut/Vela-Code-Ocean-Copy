...
for j in range(200): # return it to 200 later
    # Load data
    ...
    for i in range(30):
        ...
        print(product_of_entropy_and_uncert)
        ...
        df_log.at[i+1,'F1'] = f1
    df_log.to_csv('/data/log_w_prior.csv')
    #df.to_csv('output_w_Prior.csv')
    df_error_metrics.to_csv('/data/Error_Metric_w_Prior.csv')